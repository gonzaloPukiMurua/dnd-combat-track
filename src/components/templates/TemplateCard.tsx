    ...
    <div className={`border-2 border-slate-100 rounded-2xl bg-white transition-opacity ${isPending ? "opacity-50" : ""}`}>
      ...
      <div className="flex items-center gap-3 px-4 py-3">
        ...
        <button
          ...
          className="w-9 h-9 flex items-center justify-center rounded-lg text-slate-400 hover:text-red-500 hover:bg-red-50 transition-colors flex-shrink-0 disabled:opacity-40"
        >
          <svg viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4">
